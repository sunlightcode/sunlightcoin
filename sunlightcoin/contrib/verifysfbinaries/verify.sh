...
###   This script attempts to download the signature file SHA256SUMS.asc from sunlightcoin.org
...
WORKINGDIR="/tmp/sunlightcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://sunlightcoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://sunlightcoin.org/bin/"
VERSIONPREFIX="sunlightcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'sunlightcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[sunlightcoin-]<version>-[rc[0-9]] (example: sunlightcoin-0.9.2-rc1)"
   echo "wget output:"

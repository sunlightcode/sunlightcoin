Download URL: https://sourceforge.net/projects/sunlightcoin/files/Sunlightcoin/sunlightcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 SLC fee schedule (users still pay 0.01 SLC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #sunlightcoin00 - #sunlightcoin99

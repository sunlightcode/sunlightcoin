Sunlightcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/sunlightcoin/files/Sunlightcoin/sunlightcoin-0.5.4/
...
http://gitorious.org/sunlightcoin/sunlightcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Sunlightcoin-Qt notifications under Growl 1.3.
Increase required age of Sunlightcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSunlightcoin properly when installing Sunlightcoin-Qt over it. (Windows)

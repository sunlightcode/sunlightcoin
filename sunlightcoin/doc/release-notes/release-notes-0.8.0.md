Sunlightcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/sunlightcoin/files/Sunlightcoin/sunlightcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Sunlightcoin
...
New/changed settings (command-line or sunlightcoin.conf file)
--------------------------------------------------------

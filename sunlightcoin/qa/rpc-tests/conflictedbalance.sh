...
if [ $# -lt 1 ]; then
        ...
        echo "e.g. $0 ../../src"
        echo "Env vars SUNLIGHTCOIND and SUNLIGHTCOINCLI may be used to specify the exact binaries used"
        exit 1
fi

set -f

SUNLIGHTCOIND=${SUNLIGHTCOIND:-${1}/sunlightcoind}
CLI=${SUNLIGHTCOINCLI:-${1}/sunlightcoin-cli}
...
$SUNLIGHTCOIND $B1ARGS &
B1PID=$!

D2=${D}/node2
CreateDataDir $D2 port=11010 rpcport=11011
B2ARGS="-datadir=$D2 -debug=mempool"
$SUNLIGHTCOIND $B2ARGS &
B2PID=$!

...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(SingleColorIcon(":icons/sunlightcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Sunlightcoin Core"),
     ...
     * override -datadir in the sunlightcoin.conf file in the default data directory
     * (to be consistent with sunlightcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())

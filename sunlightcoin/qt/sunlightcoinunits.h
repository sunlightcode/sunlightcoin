...
#ifndef SUNLIGHTCOIN_QT_SUNLIGHTCOINUNITS_H
#define SUNLIGHTCOIN_QT_SUNLIGHTCOINUNITS_H
...
/** Sunlightcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SunlightcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SunlightcoinUnits(QObject *parent);

    /** Sunlightcoin units.
      @note Source: https://en.sunlightcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        STC,
...
typedef SunlightcoinUnits::Unit SunlightcoinUnit;

#endif // SUNLIGHTCOIN_QT_SUNLIGHTCOINUNITS_H

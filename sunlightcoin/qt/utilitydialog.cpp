    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Sunlightcoin Core") + " " + tr("version") + " " + "v1.5.7";// QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Sunlightcoin Core"));
        ...
        QString coreOptions = QString::fromStdString(HelpMessage(HMM_SUNLIGHTCOIN_QT));
        bool first = true;
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Sunlightcoin Core is shutting down...") + "<br /><br />" +
        tr("Do not shut down the computer until this window disappears.")));
    setLayout(layout);
}

void ShutdownWindow::showShutdownWindow(SunlightcoinGUI *window)
{
    if (!window)
        return;

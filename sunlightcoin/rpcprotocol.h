...
#ifndef SUNLIGHTCOIN_RPCPROTOCOL_H
#define SUNLIGHTCOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! Sunlightcoin is not connected
...
#endif // SUNLIGHTCOIN_RPCPROTOCOL_H

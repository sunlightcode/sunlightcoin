...
#ifndef SUNLIGHTCOIN_HASH_H
#define SUNLIGHTCOIN_HASH_H
...
/** A hasher class for Sunlightcoin's 256-bit hash (double SHA-256). */
class CHash256 {
private:
    CSHA256 sha;
public:
...
/** A hasher class for Sunlightcoin's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
    CSHA256 sha;
public:
...
/** A hasher class for Sunlightcoin's 256-bit PoW hash (Double SHA-256). */
...
/** A hasher class for Sunlightcoin's 256-bit PoW hash (Single Scrypt-256). */
...
/** A hasher class for Sunlightcoin's 256-bit PoW hash (Single Keccak-256). */

...
std::string HelpMessageCli()
{
    ...
    strUsage += "\n" + _("SSL options: (see the Sunlightcoin Wiki for SSL setup instructions)") + "\n";
...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Sunlightcoin Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  sunlightcoin-cli [options] <command> [params]  " + _("Send command to Sunlightcoin Core") + "\n" +
                  "  sunlightcoin-cli [options] help                " + _("List commands") + "\n" +
                  "  sunlightcoin-cli [options] help <command>      " + _("Get help for a command") + "\n";

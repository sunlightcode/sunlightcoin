...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CSunlightcoinAddress demoAddress = CSunlightcoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CSunlightcoinAddress setaccountDemoAddress = CSunlightcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CSunlightcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CSunlightcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}

Sunlightcoin Core version 0.9.2.1 is now available from:

  https://sunlightcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 SLC to 0.01 SLC
...
- Fix "Start sunlightcoin on system login"

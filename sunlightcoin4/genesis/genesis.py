...
def main():
  ...
  # https://en.sunlightcoin.it/wiki/Difficulty
...
def get_args():
  ...
  parser.add_option("-v", "--value", dest="value", default=5000000000,
                   type="int", help="the value in coins for the output, full value (exp. in sunlightcoin 5000000000 - To get other coins value: Block Value * 100000000)")
...
# https://en.sunlightcoin.it/wiki/Block_hashing_algorithm

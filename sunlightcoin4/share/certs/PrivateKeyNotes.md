...
unlocked to sign the Sunlightcoin-Qt.app bundle.
...
allowing somebody to distribute a Sunlightcoin-Qt.app or sunlightcoin-qt-setup.exe with a valid
...
that the sunlightcoin-qt.exe file inside the installer had not been tampered with.

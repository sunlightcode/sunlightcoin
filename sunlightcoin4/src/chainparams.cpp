...
public:
    CMainParams() {
        ...
        nSubsidyHalvingInterval = 420000; // 210000 210000000 2100000000
        ...
        const char* pszTimestamp = "ByteDance set to file lawsuit against Trump administration on Monday CGTN 20200823"; // "shanghai stock index closed at 2343.57, on 24th Sept., 2014";
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1601429440; // 1411666331
        genesis.nBits    = 0x1d00ffff; // 0x1d00ffff
        genesis.nNonce   = 2208196735; // 2056985438

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256S("0x00000000b55cc89c8c356195014d3e9c0ea87ab5dc0ae803264ffe40aeb9c17a"));
        assert(genesis.hashMerkleRoot == uint256S("0xee493bca5a728c72fbfa09943e04fc6d7aa0e26be0ea85f8721d19e6ef229ca0")); // 7bf229f629a6666596c1ce57117c28d1d29299e8a5303347929bd70847c49adb
        ...
        base58Prefixes[SECRET_KEY] =     {28}; // C prefix
